    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Form Pengembalian Buku</h3>
            </div>
                    ...
                    <table class="table table-hover">
                            ...
                            <tbody>
                              <tr v-for="t, index in datas">
                                ...
                                <td>{{ t.halaman }}</td>
                                <td>
                                    <button class="btn btn-info" @click="simpan(t.kd_act)">
                                        dikembalikan
                                    </button>
...
export default {
    ...
    methods : {
        ...
        getdata()
        {
            axios.get('/peminjaman/buku/dikebalikan')
        .then(response => {
            this.datas = response.data;
         })
        },
        simpan(id_act)
        {
            axios.put('/api/update/peminjaman/buku/'+ id_act+'/dikembaliakan')
            .then(response => {
